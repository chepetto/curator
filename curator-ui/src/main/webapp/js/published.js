...
$.widget("curator.suggest", {
    ...
    _init:function () {
        ...
        $this._retrieve('/curator/rest/article/list/featured');
    },
    ...
    _clusterArticlesPerDay:function (interval, firstTime, articleList) {
        ...
        for (var id in articleList) {
            ...
            var featuredTime = curator.util.strToDate(article.featuredTime);

            var dayIndex = parseInt((firstTime - featuredTime) / interval);
